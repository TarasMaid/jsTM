...
// 1 машина- Створити функцію конструктор яка дозволяє створювати об'єкти car, з властивостями модель, виробник, рік випуску, максимальна швидкість, об'єм двигуна. додати в об'єкт функції:
...
//
// }
// const car1 = new Car('E38', 'BMW', 1994, 250, 2);
// car1.drive()
// car1.info()
...
// 2 машина - (Те саме, тільки через клас)
...
// }
//
// const car2 = new Car2('e38', 'BMW', 1994, 250, 2);
// car2.drive();
// car2.info();
...
// car2.info();
// car2.addDriver({name: 'Igor', age: 56, exp: 10});
// car2.info();
//
...
class Prince extends Human {
    ...
    findCinderella1(arr) {
        if (!this.bootSize) throw new Error('Пропало')
...
// йти необхідну попелюшку за допомоги функції масиву find та відповідного колбеку